...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Web Novel Manager'),
    ...
    */
    ...
    | the arrays below to provide additional functionality to this app.
    |
    */
    ...
    | be loaded to this array. Aliases are lazy-loaded for performance.
    |
    */
